        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
          <ul class="navbar-nav mx-auto">
            <li class="nav-item dropdown">
              <button class="btn btn-md dropdown-toggle products" type="button" data-toggle="dropdown" id="dropdownMenuButton" aria-haspopup="true" aria-expanded="false">
                Products
              </button>
            ...
            <li class="nav-item dropdown">
              <button class="btn btn-md dropdown-toggle services" type="button" data-toggle="dropdown" id="dropdownMenuButton" aria-haspopup="true" aria-expanded="false">
                Services
              </button>
              <span class="rectangle"></span>
              <span class="triangle"></span>
            ...
            <li class="nav-item dropdown">
              <button class="btn btn-md dropdown-toggle apps" type="button" data-toggle="dropdown" id="dropdownMenuButton" aria-haspopup="true" aria-expanded="false">
                Applications
              </button>
              <span class="rectangle"></span>
              <span class="triangle"></span>
            ...
            <li class="nav-item dropdown">
              <button class="btn btn-md dropdown-toggle resources" type="button" data-toggle="dropdown" id="dropdownMenuButton" aria-haspopup="true" aria-expanded="false">
                Resources
              </button>
              <span class="rectangle"></span>
              <span class="triangle"></span>
            ...
            <li class="nav-item dropdown">
              <button class="btn btn-md dropdown-toggle about" type="button" data-toggle="dropdown" id="dropdownMenuButton" aria-haspopup="true" aria-expanded="false">
                About
              </button>
              <span class="rectangle"></span>
              <span class="triangle"></span>
